...
const makeRecord = (type: RecordType, amount: number, category: string, date: Date) => ({
    amount,
    type,
    category,
    date,
...
const mockUser: AuthUser = { id: 'u1', email: 'test@finance.com', role: Role.ANALYST };
const adminUser: AuthUser = { id: 'admin1', email: 'admin@finance.com', role: Role.ADMIN };
